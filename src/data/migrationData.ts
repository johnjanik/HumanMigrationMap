...
export const migrationEvents: MigrationEvent[] = [
  ...
  { time_kya: 12, parent: "GHIJK", child: "G", event_type: "branch", parent_lat: 35, parent_lon: 55, child_lat: 40, child_lon: 44, color: "#9370DB", description: "G Eastern Anatolia/Armenia" },
  { time_kya: 8.8, parent: "G", child: "G-NearEast", event_type: "neolithic", parent_lat: 40, parent_lon: 44, child_lat: 33, child_lon: 35, color: "#9370DB", description: "G Neolithic Near East input" },
  { time_kya: 9, parent: "G", child: "G2a", event_type: "branch", parent_lat: 40, parent_lon: 44, child_lat: 39, child_lon: 35, color: "#8A2BE2", description: "G2a branch" },
  { time_kya: 8.5, parent: "G2a", child: "G2a-Greece", event_type: "neolithic", parent_lat: 39, parent_lon: 35, child_lat: 38, child_lon: 23, color: "#8A2BE2", description: "G2a to Greece" },
  { time_kya: 8, parent: "G2a-Greece", child: "G2a-Balkans", event_type: "neolithic", parent_lat: 38, parent_lon: 23, child_lat: 44, child_lon: 20, color: "#8A2BE2", description: "G2a Balkans" },
  { time_kya: 7.5, parent: "G2a-Balkans", child: "G2a-LBK", event_type: "neolithic", parent_lat: 44, parent_lon: 20, child_lat: 50, child_lon: 10, color: "#8A2BE2", description: "G2a LBK culture" },
  { time_kya: 7, parent: "G2a-LBK", child: "G2a-Germany", event_type: "neolithic", parent_lat: 50, parent_lon: 10, child_lat: 51.5, child_lon: 10.5, color: "#8A2BE2", description: "G2a Neolithic Germany" },
  { time_kya: 6.5, parent: "G2a-LBK", child: "G2a-France-multi", event_type: "neolithic", parent_lat: 50, parent_lon: 10, child_lat: 46.6, child_lon: 2.2, color: "#8A2BE2", description: "G2a Neolithic France spread" },
  { time_kya: 7, parent: "G2a", child: "G2a-Italy", event_type: "neolithic", parent_lat: 39, parent_lon: 35, child_lat: 42, child_lon: 12, color: "#8A2BE2", description: "G2a to Italy/Sardinia" },
  { time_kya: 6, parent: "G2a-Italy", child: "G2a-Italy2", event_type: "neolithic", parent_lat: 42, parent_lon: 12, child_lat: 42, child_lon: 12.5, color: "#8A2BE2", description: "G2a Italy spread" },
  { time_kya: 7, parent: "G2a-LBK", child: "G2a-Iberia", event_type: "neolithic", parent_lat: 50, parent_lon: 10, child_lat: 40, child_lon: -3, color: "#8A2BE2", description: "G2a to Iberia" },
  { time_kya: 6, parent: "G2a-Iberia", child: "G2a-Iberia2", event_type: "neolithic", parent_lat: 40, parent_lon: -3, child_lat: 41.8, child_lon: 1.8, color: "#8A2BE2", description: "G2a Iberian spread" },
  { time_kya: 6.5, parent: "G2a-LBK", child: "G2a-France", event_type: "neolithic", parent_lat: 50, parent_lon: 10, child_lat: 47, child_lon: 2, color: "#8A2BE2", description: "G2a to France" },
  { time_kya: 6, parent: "G2a-France", child: "G2a-Britain", event_type: "neolithic", parent_lat: 47, parent_lon: 2, child_lat: 52, child_lon: -1, color: "#8A2BE2", description: "G2a to Britain" },
